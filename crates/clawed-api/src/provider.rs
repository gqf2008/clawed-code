...
impl ApiBackend for BedrockBackend {
    ...
    fn map_model_id(&self, canonical: &str) -> String {
        ...
        clawed_core::model::model_for_provider(canonical, clawed_core::model::ApiProvider::Bedrock)
    }
...
impl ApiBackend for VertexBackend {
    ...
    fn map_model_id(&self, canonical: &str) -> String {
        clawed_core::model::model_for_provider(canonical, clawed_core::model::ApiProvider::Vertex)
    }

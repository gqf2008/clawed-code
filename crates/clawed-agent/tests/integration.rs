//! Integration tests for the clawed-agent crate.
//!
...
use clawed_agent::engine::QueryEngineBuilder;
use clawed_agent::permissions::PermissionChecker;
use clawed_agent::state::new_shared_state;
use clawed_agent::system_prompt::{build_system_prompt_ext, DynamicSections};
...
async fn test_session_save_and_load() {
    ...
    // Cleanup
    let _ = clawed_core::session::delete_session(&sid);
}
...
fn test_cost_tracker_accumulation() {
    ...
    let usage1 = clawed_core::message::Usage {
        input_tokens: 1000,
        output_tokens: 500,
    ...
    let usage2 = clawed_core::message::Usage {
        input_tokens: 2000,
        output_tokens: 1000,
...
fn test_mcp_tool_name_roundtrip() {
    use clawed_tools::mcp::{format_mcp_tool_name, parse_mcp_tool_name};
    ...
    // the last assistant Usage).
    {
        ...
        s.messages.push(clawed_core::message::Message::Assistant(
            clawed_core::message::AssistantMessage {
                ...
                stop_reason: None,
                usage: Some(clawed_core::message::Usage {
